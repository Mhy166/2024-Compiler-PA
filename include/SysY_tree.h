...
public:
    ...
    bool Exp(){return 0;}
    Expression GetExp(){return nullptr;}
    bool IsConst(){return 1;}
    void codeIR();
    void TypeCheck();
    void printAST(std::ostream &s, int pad);
};
...
public:
    virtual Type::ty GetType()=0;
    virtual std::vector<Def> * GetDef()=0;
    virtual bool IsConst()=0;
};
...
public:
    ...
    Type::ty GetType(){return type_decl;}
    std::vector<Def> * GetDef(){return var_def_list;}
    bool IsConst(){return false;}
